...
double  _kTrackHeight = getHp(22);
double  _kTrackWidth =getHp(50);
double _kTrackRadius = _kTrackHeight / 2.0;
 double _kThumbRadius = getHp(11);
...
class _SwitchState extends State<MySwitch> with TickerProviderStateMixin {
